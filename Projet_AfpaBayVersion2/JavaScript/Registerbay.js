...
function create_register(){
    ...
    var divimgcapt = document.createElement('div');
    ...
    var spanCaptcha = document.createElement('span');
    var imgcapt = document.createElement('span');
    ...
    var imgcapt = document.createElement('img');
    ...
    var glyphCaptcha = document.createElement('i');
    ...
    age.name = 'newuserage';
    imgcapt.src = 'captcha.php'
    Captcha.type = 'text';
    Captcha.className = 'form-control';
    Captcha.placeholder = 'Recopier le code';
    Captcha.name = 'secure';
    ...
    divCaptcha.className = 'input-group';
    ...
    glyphCaptcha.className = 'glyphicon glyphicon-info-sign';
    ...
    spanCaptcha.className = 'input-group-addon';
    ...
    spanCaptcha.appendChild(glyphCaptcha);
    divCaptcha.appendChild(spanCaptcha);
    divCaptcha.appendChild(Captcha);
    formulaire.appendChild(divID);
    formulaire.appendChild(divAge);
    formulaire.appendChild(divPW);
    formulaire.appendChild(divconfirmPW);
    formulaire.appendChild(divCaptcha);
